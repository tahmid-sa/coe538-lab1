...
public class Flight {
    ...
    //The Flight constructor is performs accordingly:
    ...
    //setCapacity: accepts capacity and planeVacant, and initializes instance variable capacity to capacity,
    //and numberOfSeatsLeft accordingly to the if condition
    public boolean setCapacity(int capacity, boolean planeVacant) {
        int seatsLeft;
        seatsLeft = this.numberOfSeatsLeft + this.capacity - capacity;
        
        //In here, if the plane is not vacant, then numberOfSeatsLeft is updated to seatsLeft, 
        //else if the plane is vacant, numberOfSeats must equal capacity
        if (planeVacant == false && seatsLeft > 0) {
